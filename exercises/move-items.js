...
function updatedCollections (id, direction) {
...
allItems.forEach(item => {
	item.addEventListener('click', function () {
		...
		const isMain = item.parentElement.id === 'main';

		const direction = isMain ? 'toFavs' : 'toMain';

		updatedCollections(itemId, direction);
